...
function Register() {
  ...
  const handleSignup = (e) => {
    ...
    axiosAPI.post('http://localhost:5000/signup', { formdata })
  ...
  return (
    <div id='div'>
      <form className='register-form' onSubmit={handleSignup} action='post'>
        ...
        <label>Email:</label>
        <br />
        <input type="text" name="Email" placeholder="@gmail.com" id='in' onChange={(e) => setFormdata({ ...formdata, Email: e.target.value })} />
        <br />
